...
//                drawAttackCombo(ctx, ac);
                ...
                if (ac.targetHitter === "F") {
                    var cones = [
                        [{ x: 98, y: 0 }, { x: 100, y: 96 }, { x: 88, y: 96 }, { x: 98, y: 0 }],
                        [{ x: 98, y: 0 }, { x: 88, y: 96 }, { x: 73, y: 92 }, { x: 98, y: 0 }],
                        [{ x: 98, y: 0 }, { x: 72, y: 96 }, { x: 57, y: 90 }, { x: 98, y: 0 }],
                        [{ x: 98, y: 0 }, { x: 54, y: 96 }, { x: 34, y: 84 }, { x: 98, y: 0 }],
                        [{ x: 98, y: 0 }, { x: 28, y: 92 }, { x: 0, y: 70 }, { x: 98, y: 0 }],
                        [{ x: 98, y: 0 }, { x: 15, y: 59 }, { x: 2, y: 39 }, { x: 98, y: 0 }],
                        [{ x: 98, y: 0 }, { x: 9, y: 36 }, { x: 2, y: 0 }, { x: 98, y: 0 }]
                    ];
                    var textPt = [{ x: 94, y: 86 }, { x: 81, y: 88 }, { x: 67, y: 85 }, { x: 49, y: 81 }, { x: 20, y: 76 }, { x: 17, y: 44 }, { x: 15, y: 18 }];
                    ...
                    var nn = coneno - 1;
                    {
                        ...
                        var py = y + yy * yscale;
                        var dx = 20;
                        writeText({ ctx: ctx, text: evs.length.toString(), x: px - dx, y: py - dx, width: dx * 2, }, { textAlign: 'centre', fontSize: fontsize });
                        writeText({ ctx: ctx, text: pc.toFixed(0) + '%', x: px - dx, y: py, width: dx * 2, }, { textAlign: 'centre', fontSize: fontsize });
                    }
                }
                else if (ac.targetHitter === "B") {
                    var cones = [
                        [{ x: 2, y: 0 }, { x: 0, y: 96 }, { x: 12, y: 96 }, { x: 2, y: 0 }],
                        [{ x: 2, y: 0 }, { x: 27, y: 92 }, { x: 12, y: 96 }, { x: 2, y: 0 }],
                        [{ x: 2, y: 0 }, { x: 43, y: 90 }, { x: 28, y: 96 }, { x: 2, y: 0 }],
                        [{ x: 2, y: 0 }, { x: 66, y: 84 }, { x: 46, y: 96 }, { x: 2, y: 0 }],
                        [{ x: 2, y: 0 }, { x: 100, y: 70 }, { x: 72, y: 92 }, { x: 2, y: 0 }],
                        [{ x: 2, y: 0 }, { x: 98, y: 39 }, { x: 85, y: 59 }, { x: 2, y: 0 }],
                        [{ x: 2, y: 0 }, { x: 98, y: 0 }, { x: 91, y: 36 }, { x: 2, y: 0 }]
                    ];
                    var textPt = [{ x: 4, y: 86 }, { x: 19, y: 87 }, { x: 33, y: 86 }, { x: 52, y: 82 }, { x: 80, y: 76 }, { x: 83, y: 44 }, { x: 87, y: 18 }];
                    ...
                    var cones = [
                        [{ x: 50, y: 0 }, { x: 100, y: 40 }, { x: 66, y: 54 }, { x: 50, y: 0 }],
                        [{ x: 50, y: 0 }, { x: 100, y: 80 }, { x: 80, y: 90 }, { x: 50, y: 0 }],
                        [{ x: 50, y: 0 }, { x: 80, y: 90 }, { x: 60, y: 92 }, { x: 50, y: 0 }],
                        [{ x: 50, y: 0 }, { x: 60, y: 92 }, { x: 40, y: 92 }, { x: 50, y: 0 }],
                        [{ x: 50, y: 0 }, { x: 40, y: 92 }, { x: 20, y: 90 }, { x: 50, y: 0 }],
                        [{ x: 50, y: 0 }, { x: 0, y: 90 }, { x: 20, y: 92 }, { x: 50, y: 0 }],
                        [{ x: 50, y: 0 }, { x: 33, y: 54 }, { x: 0, y: 40 }, { x: 50, y: 0 }],
                        [{ x: 50, y: 0 }, { x: 60, y: 54 }, { x: 40, y: 54 }, { x: 50, y: 0 }]
                    ];
                    var textPt = [{ x: 80, y: 40 }, { x: 90, y: 78 }, { x: 70, y: 83 }, { x: 50, y: 84 }, { x: 30, y: 83 }, { x: 10, y: 78 }, { x: 20, y: 40 }, { x: 50, y: 46 }];
                    var nn = coneno - 1;
                    {
                        ctx.beginPath()
                        var sxx = 100 - ptStart.x;
    ...
    const draw = ctx => {
        ...
        for (var z = 0; z < 9; z++) {
            ...
            for (var npl = 0; npl < plsobjs.length; npl++) {
                var obj = plsobjs[npl]
                tx = x;
                writeText({ ctx: ctx, text: obj.player.NickName.toUpperCase(), x: tx + 2, y: ty, width: w3 - tw }, { textAlign: 'left', fontSize: fontsize, fontFamily: 'Inter var' });
                writeText({ ctx: ctx, text: obj.count.toString(), x: tx + w3 - 4, y: ty, width: w3 - 4 }, { textAlign: 'right', fontSize: fontsize });
                ty += th;
            }
